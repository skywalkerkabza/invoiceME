[![Discord](https://img.shields.io/badge/Discord-%40InvoiceME-000000?style=flat&logo=Discord&logoColor=#5865F2)](https://discord.gg/uhXKHbVKHZ)
# InvoiceME
...
![InvoiceME Website image](/public/assets/img/InvoiceME-web-app.png)
...
> [!NOTE]
> Please be advised that there are currently issues when using this application in the Mozilla Firefox browser. For more information, refer to [Issue #11](https://github.com/aliabb01/InvoiceME/issues/11).

Visit the [live demo](https://InvoiceME.vercel.app) to see InvoiceME in action.

## Getting Started

Follow these instructions to get InvoiceME up and running on your local machine.
...
1. Clone the repository:
   ...
   ```bash 
   git clone https://github.com/skywalkerkabza/invoiceME.git
   cd InvoiceME
   ```
